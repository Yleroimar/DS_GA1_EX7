...
class TestRingLeavings(AddedAsserts):
    ...
    def testLeaving17_shortcuts(self):
        self.assertRingLeave(
                Ring(1, 100, [10, 30, 50, 70, 90], [(50, 10), (50, 30), (30, 90)]),
                50,
                "10:, S-30, NS-70",
                "30:90, S-70, NS-90",
                "70:, S-90, NS-10",
    ...
    def testLeaving18_shortcuts(self):
        self.assertRingLeave(
                Ring(1, 100, [10, 30, 50, 70, 90], [(50, 10), (50, 30), (10, 70)]),
                70,
                "10:, S-30, NS-50",
                "30:, S-50, NS-90",
                "50:10,30, S-90, NS-10",
    ...
    def testLeaving99_example(self):
        self.assertRingLeave(
                Ring(1, 100, [5, 7, 17, 22, 56, 71, 89, 92], [(5, 56), (5, 71), (22, 89)]),
                5,
                "7:, S-17, NS-22",
                "17:, S-22, NS-56",
                "22:89, S-56, NS-71",
